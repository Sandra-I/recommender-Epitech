...
class GetFileFromUrl:
    ...
    def __init__(self):
        url_clean_dataset = 'http://recommender31.s3-website.eu-west-3.amazonaws.com/clean_dataset.csv'
        #url_best_item = 'http://recommender31.s3-website.eu-west-3.amazonaws.com/best_item_by_cli.csv'
        #url_freq_item = 'http://recommender31.s3-website.eu-west-3.amazonaws.com/frequence_item.csv'
        #url_paired_item = 'http://recommender31.s3-website.eu-west-3.amazonaws.com/paired_item.csv'
        #url_rfm_cli_art = 'http://recommender31.s3-website.eu-west-3.amazonaws.com/cli_article_rfm_segment.csv'
